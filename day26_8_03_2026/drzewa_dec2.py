...
# wskażnik giniego lub entropia (entropia - logarytmiczna - wolniejsze)
...
# obliczmy wskażnik
print("Gini (całośc)", round(gini_index(dane), 3))
print("Gini po podziale (wiek > 50)", round(gini_po_podziale(wiek_lewo, wiek_prawo), 3))
# Gini (całośc) 0.48
# Gini po podziale (wiek > 50) 0.45 -> raczej idziemy w dobrą strone, poprawnie wybrany podział
...
print("Gini (całośc)", round(gini_index(dane), 3))
print("Gini po podziale (wiek > 50)", round(gini_po_podziale(zarobki_lewo, zarobki_prawo), 3))
# Gini (całośc) 0.48
# Gini po podziale (wiek > 50) 0.4
